...
java -jar clients-0.1.jar --server.port=$serverPort --config.rpc.host=$host --config.rpc.port=$rpcport --config.rpc.username=$username --config.rpc.password=$password
